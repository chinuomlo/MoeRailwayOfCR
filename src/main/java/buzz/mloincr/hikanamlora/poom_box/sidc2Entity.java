...
public class sidc2Entity extends BlockEntity{
    private String zhanming = "拉白";
    private String quanping = "←甘洛  迤资→";
    public sidc2Entity(BlockPos pos, BlockState state) {
        super(Hikanamlora.sidc2_En,pos, state);
    }
    @Override
