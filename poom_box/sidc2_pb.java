...
public class sidc2_pb extends HorizontalFacingBlock implements BlockEntityProvider {
    //无需多言
    public sidc2_pb (Settings settings){
        super(settings);
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext ctx) {
		...
		switch(dir) {
			case NORTH:
				return VoxelShapes.cuboid(0, 0, 0.4375, 1, 2, 0.5625);
			case SOUTH:
				return VoxelShapes.cuboid(0, 0, 0.4375, 1, 2, 0.5625);
			case EAST:
				return VoxelShapes.cuboid(0.4375, 0, 0, 0.5625, 2, 1);
			case WEST:
				return VoxelShapes.cuboid(0.4375, 0, 0, 0.5625, 2, 1);
			default:
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new sidc2Entity(pos, state);
	}
}
