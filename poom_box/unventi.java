...
public class unventi extends HorizontalFacingBlock {
 
	public unventi(Settings settings) {
		super(settings);
	...
	public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext ctx) {
		...
		switch(dir) {
			case NORTH:
				return VoxelShapes.cuboid(-1, -2, 0.5, 2, -1, 1);
			case SOUTH:
				return VoxelShapes.cuboid(-1, -2, 0, 2, -1, 0.5);
			case EAST:
				return VoxelShapes.cuboid(0, -2, -1, 0.5, -1, 2);
			case WEST:
				return VoxelShapes.cuboid(0.5, -2, -1, 1, -1, 2);
			default:
